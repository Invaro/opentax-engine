    ...
    <main className="min-h-screen">
      ...
      <div className="container max-w-[680px] py-16 md:py-24">
        ...
        <Section label="00" title="The short version">
          <p>
            We collect as close to nothing as we can get away with. No cookies, no analytics, no ad
            pixels, no fingerprinting. Your tax facts are computed and returned — never stored. The
            only personal data we ever hold is an email address you explicitly gave us, and you can
            delete it with one message.
          </p>
        </Section>

        <Section label="01" title="This website">
          <p>
            The site sets no cookies and loads no third-party analytics or trackers. Your
            light/dark preference is kept in your browser&apos;s local storage and never leaves it.
            Our hosting provider (Vercel) keeps standard, short-lived request logs — as every host
            does.
          </p>
        </Section>
